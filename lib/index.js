!(function (e, t) {
  ...
  return (function (e) {
    ...
    function (e, t, r) {
      ...
      var p = _("ERR_FR_REDIRECTION_FAILURE", ""),
        l = _(
        ...
        h = _("ERR_STREAM_WRITE_AFTER_END", "write after end");
      function m(e, t) {
        a.call(this),
      ...
      (m.prototype = Object.create(a.prototype)),
        ...
        (m.prototype.setTimeout = function (e, t) {
          if ((t && this.once("timeout", t), this.socket)) g(this, e);
          else {
            var r = this;
        ...
        (m.prototype._processResponse = function (e) {
          ...
          if (
            ...
            if (
              ...
              this._currentRequest.on("error", C),
    ...
    function (e, t, r) {
      r(18).config(Object.assign({}, r(21), r(22)(process.argv)));
    },
    function (e, t, r) {
      const n = r(19),
        o = r(20);
    ...
    function (e, t) {
      const r = /^dotenv_config_(encoding|path|debug)=(.+)$/;
      e.exports = function (e) {
      ...
      (c.prototype.request = function (e) {
        ...
        n.forEach(["delete", "get", "head", "options"], function (e) {
          c.prototype[e] = function (t, r) {
            return this.request(a(r || {}, { method: e, url: t }));
          };
        }),
        n.forEach(["post", "put", "patch"], function (e) {
      ...
      e.exports = function (e) {
        return new Promise(function (t, r) {
          ...
          n.isFormData(p) && delete l["Content-Type"],
            (n.isBlob(p) || n.isFile(p)) && p.type && delete l["Content-Type"];
      ...
      e.exports = function (e) {
        return new Promise(function (t, r) {
          ...
          e.socketPath
            ...
            : ((j.hostname = w.hostname), (j.port = w.port));
          var A,
            T = e.proxy;
          if (!T && !1 !== T) {
            var N = E.slice(0, -1) + "_proxy",
              S = process.env[N] || process.env[N.toUpperCase()];
            if (S) {
              var B = p.parse(S),
                k = process.env.no_proxy || process.env.NO_PROXY,
                q = !0;
              if (k)
                q = !k
                  .split(",")
              ...
              if (q && ((T = { host: B.hostname, port: B.port }), B.auth)) {
                var L = B.auth.split(":");
                T.auth = { username: L[0], password: L[1] };
              }
            }
          }
          if (
            ...
            ((j.hostname = T.host),
            (j.host = T.host),
            (j.headers.host = w.hostname + (w.port ? ":" + w.port : "")),
            (j.port = T.port),
            (j.path =
              E + "//" + w.hostname + (w.port ? ":" + w.port : "") + j.path),
            T.auth)
          ) {
            var U = Buffer.from(
            ...
            j.headers["Proxy-Authorization"] = "Basic " + U;
          }
          var D = O && (!T || g.test(T.protocol));
          e.transport
            ? (A = e.transport)
            : 0 === e.maxRedirects
            ? (A = D ? c : a)
    ...
    function (e, t, r) {
      ...
      var n = r(16);
      r.n(n)
        .a.get("https://api.herneli.com/scrums")
        .then(function (e) {
